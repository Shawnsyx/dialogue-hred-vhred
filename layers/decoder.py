...
import math
from .insert_pretrained_embedd import *
...
class DecoderRNN(BaseRNNDecoder):
    def __init__(self, vocab_size, embedding_size,
        ...
        pre_embed = insert_embed(self.vocab_size)
        self.embedding.weight = nn.Parameter(torch.tensor(pre_embed,dtype=torch.float32))
